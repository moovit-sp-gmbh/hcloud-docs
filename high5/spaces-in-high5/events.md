---
description: Events and streams inside events can be found here.
---

# Events

An event is a starting point for one or multiple streams. All streams that are to be found underneath one event will execute in the order of their listing (starting at the top), when the event has been triggered (e.g. by an [event webhook](webhooks.md)).
