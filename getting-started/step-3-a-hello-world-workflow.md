...
* Give it a name that makes sense to you
* Wait for a good example worflow to show here

### Already hooked?

Every workflow needs a starting point. In helmut.cloud, multiple triggers are available to introduce a workflow. An easy, but powerful way to trigger something are webhooks.
