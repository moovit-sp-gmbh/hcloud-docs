...
* MacOS will warn you that the installer cannot be verified - choose okay
* Follow along the installation routine and finish installation

The HCloud.app will be installed into the Applications folder.
...
Open _System Preferences_ via the Apple icon in the upper left corner of your Mac. Navigate to "_Privacy and Security_". Here, you can set granular privileges in _Files and Folders_ or add _HCloud.app_ to Full Disc Access, if your workflow demands it. If you are running HCloud.app unattended, consider to set full disc access to avoid requests blocking your executions.
